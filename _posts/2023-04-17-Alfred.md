...
Throughout this article, I will describe step-by-step how I approached this challenge and ultimately gained admin access to the Alfrede machine. If you're interested in learning more about cybersecurity and how to resolve machines using an OSCP-based methodology, then keep reading and join me on this adventure!"
date: 2023-04-17
classes: wide
header:
...
This is a write-up for the SAlfred machine on the TryHackme platform. We tackled this pentesting exercise using the approach and methodology of OSCP.
